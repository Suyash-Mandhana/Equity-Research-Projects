...
**Suyash | Chartered Accountant**

---

Equity research covering sector-level analysis and single-stock coverage across Indian markets. Each project combines industry analysis with financial modelling to arrive at an investment view supported by data. Research is published in report format with supporting models.
...
- Sector-level research and industry mapping
- Company-level initiation of coverage (business analysis, financial modelling, target price derivation)
- Comparative valuation across peer sets
- Thematic research: indigenisation, policy impact analysis, structural growth drivers
- Report writing: structured, source-cited, investment-grade research output
